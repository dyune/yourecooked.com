...
export const TableDemo = () => {
  ...
  return (
    ...
    <Table>
      ...
      <TableFooter>
        <TableRow>
          <TableCell colSpan={2}>Total Applications</TableCell>
...
export function ButtonDemo() {
    return (
      <div className="relative">
        ...
        <Button className="absolute top-10 right-12 w-10 h-10 text-3xl">
        +
      </Button>

      <Button className="absolute top-10 right-24 w-10 h-10 text-3xl">
        -
      </Button>
      </div>
    );
